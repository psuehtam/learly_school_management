...
public class LearlyDbContext : DbContext
{
    ...
    public DbSet<TurmaDiaSemana> TurmasDiasSemana => Set<TurmaDiaSemana>();
    public DbSet<TurmaCapituloProgresso> TurmasCapitulosProgresso => Set<TurmaCapituloProgresso>();
